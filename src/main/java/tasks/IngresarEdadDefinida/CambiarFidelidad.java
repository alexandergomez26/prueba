...
import static userinterfaces.AutorizacionPage.MESADA;

public class CambiarFidelidad implements Task {
    ...
    public static CambiarFidelidad enElAplicativo(List<String> datos){
        return Tasks.instrumented(CambiarFidelidad.class, datos.get(0));
    }
}
