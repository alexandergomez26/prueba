...
public class CambiarFidelidadEdadDefinidaBono implements Task {
    ...
    public static CambiarFidelidadEdadDefinidaBono enElAplicativo(List<String> datos){
        return Tasks.instrumented(CambiarFidelidadEdadDefinidaBono.class, datos.get(0));
    }
}
