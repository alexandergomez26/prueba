...
public class IngresarDatosAfiliadoHombre implements Task {
    ...
    public IngresarDatosAfiliadoHombre(String datos) {
    ...
    public static IngresarDatosAfiliadoHombre enClienteActual(List<String> datos){
        return Tasks.instrumented(IngresarDatosAfiliadoHombre.class, datos.get(0));
    }
}
