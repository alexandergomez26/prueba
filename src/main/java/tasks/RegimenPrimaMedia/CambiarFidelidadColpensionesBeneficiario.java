...
public class CambiarFidelidadColpensionesBeneficiario implements Task {
    ...
    public static CambiarFidelidadColpensionesBeneficiario enElAplicativo(List<String> datos){
        return Tasks.instrumented(CambiarFidelidadColpensionesBeneficiario.class, datos.get(0));
    }
}
