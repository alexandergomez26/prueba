...
public class IngresarDatosIngresoAntesDeJunioDobleAsesoria implements Task {

    private final DatosAfiliado datosAfiliado;
    private final String datos;

    public IngresarDatosIngresoAntesDeJunioDobleAsesoria(String datos) {
        this.datos = datos;
    ...
    public static IngresarDatosIngresoAntesDeJunioDobleAsesoria EnClientePotencial(List<String> datos){
        return Tasks.instrumented(IngresarDatosIngresoAntesDeJunioDobleAsesoria.class, datos.get(0));
    }
}