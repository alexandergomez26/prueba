...
import static userinterfaces.AutorizacionPage.FIDELIDAD_PERSONALIZADA_A_PARTIR_UNA_EDAD_100;
...
public class CambiarFidelidadAPartirEdadDefinidaBono implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        logger.log(Level.INFO, "Resultado Final 50%:"+ServiceExcelDrive.getDataCell("D45"));
        ...
        logger.log(Level.INFO, "Resultado Final 0%:"+ServiceExcelDrive.getDataCell("D45"));
    ...
    public static CambiarFidelidadAPartirEdadDefinidaBono enElAplicativo(List<String> datos){
        return Tasks.instrumented(CambiarFidelidadAPartirEdadDefinidaBono.class, datos.get(0));
    }
}
