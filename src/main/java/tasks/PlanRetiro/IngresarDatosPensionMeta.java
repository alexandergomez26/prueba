...
public class IngresarDatosPensionMeta implements Task {
    private final String datos;
    private final DatosAfiliado datosAfiliado;

    public IngresarDatosPensionMeta(String datos) {
        this.datos = datos;
    ...
    public static IngresarDatosPensionMeta enElAplicativo(List<String> datos){
        return Tasks.instrumented(IngresarDatosPensionMeta.class, datos.get(0));
    }
}
