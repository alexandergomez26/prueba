...
public class CambiarFidelidadAsesoriaPensional implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        System.out.println("Valor Capital Fidelidad 50.79% : " + VALOR_PENSION_ASESORIA_PENSIONAL_50_79.resolveFor(actor).getTextValue());
        System.out.println("Valor Mesada 50.79%: " + VALOR_MESADA_ASESORIA_PENSIONAL_50_79.resolveFor(actor).getTextValue());
    ...
    public static CambiarFidelidadAsesoriaPensional enElAplicativo(List<String> datos){
        return Tasks.instrumented(CambiarFidelidadAsesoriaPensional.class, datos.get(0));
    }
}
