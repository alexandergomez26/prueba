...
public class CambiarFidelidadAsesoriaPensionalBono implements Task {

    @Override
    public <T extends Actor> void performAs(T actor) {

        System.out.println("Valor Capital Fidelidad 100% : " + VALOR_PENSION_ASESORIA_PENSIONAL.resolveFor(actor).getTextValue());
        System.out.println("Valor Mesada 100%: " + VALOR_MESADA_ASESORIA_PENSIONAL.resolveFor(actor).getTextValue());
        System.out.println("Valor Capital Fidelidad 75% : " + VALOR_PENSION_ASESORIA_PENSIONAL_75.resolveFor(actor).getTextValue());
        System.out.println("Valor Mesada 75%: " + VALOR_MESADA_ASESORIA_PENSIONAL_75.resolveFor(actor).getTextValue());
        System.out.println("Valor Capital Fidelidad 50% : " + VALOR_PENSION_ASESORIA_PENSIONAL_50.resolveFor(actor).getTextValue());
        System.out.println("Valor Mesada 50%: " + VALOR_MESADA_ASESORIA_PENSIONAL_50.resolveFor(actor).getTextValue());
        System.out.println("Valor Capital Personalizada : " + VALOR_PENSION_ASESORIA_PENSIONAL_50_79.resolveFor(actor).getTextValue());
        System.out.println("Valor Mesada Personalizada : " + VALOR_MESADA_ASESORIA_PENSIONAL_50_79.resolveFor(actor).getTextValue());
        System.out.println("Valor Capital Fidelidad 0% : " + VALOR_PENSION_ASESORIA_PENSIONAL_0.resolveFor(actor).getTextValue());
        System.out.println("Valor Mesada 0%: " + VALOR_MESADA_ASESORIA_PENSIONAL_0.resolveFor(actor).getTextValue());


        DatosPension datosPension = new DatosPension(
                VALOR_PENSION_ASESORIA_PENSIONAL_75.resolveFor(actor).getTextValue(),
                VALOR_MESADA_ASESORIA_PENSIONAL_75.resolveFor(actor).getTextValue(),
        ...
        DatosPension datosPension2 = new DatosPension(
                VALOR_PENSION_ASESORIA_PENSIONAL_50.resolveFor(actor).getTextValue(),
                VALOR_MESADA_ASESORIA_PENSIONAL_50.resolveFor(actor).getTextValue(),
        ...
        DatosPension datosPension3 = new DatosPension(
                VALOR_PENSION_ASESORIA_PENSIONAL_50_79.resolveFor(actor).getTextValue(),
                VALOR_MESADA_ASESORIA_PENSIONAL_50_79.resolveFor(actor).getTextValue(),
        ...
        DatosPension datosPension4 = new DatosPension(
                VALOR_PENSION_ASESORIA_PENSIONAL_0.resolveFor(actor).getTextValue(),
                VALOR_MESADA_ASESORIA_PENSIONAL_0.resolveFor(actor).getTextValue(),
    ...
    public static CambiarFidelidadAsesoriaPensionalBono enElAplicativo(List<String> datos){
        return Tasks.instrumented(CambiarFidelidadAsesoriaPensionalBono.class, datos.get(0));
    }
}
