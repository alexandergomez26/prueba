...
public class SeleccionarTipoDeCalculoBonosAsesoria implements Task {  //validar eliminar clase
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        System.out.println("Valor Pension: " + VALOR_PENSION_ASESORIA_PENSIONAL_100_BONOS.resolveFor(actor).getText());// validar
        System.out.println("Valor de la Mesada: " + VALOR_MESADA_ASESORIA_PENSIONAL_100_BONOS.resolveFor(actor).getText());
        System.out.println("Edad pension: " + EDAD_PENSION_ASESORIA_PENSIONAL_BONOS.resolveFor(actor).getText());
        ...
        DatosPension datosPension = new DatosPension(
                ...
                EDAD_PENSION_ASESORIA_PENSIONAL_BONOS.resolveFor(actor).getTextValue(),
    ...
    public static SeleccionarTipoDeCalculoBonosAsesoria pensional(List<String> datos){
        return Tasks.instrumented(SeleccionarTipoDeCalculoBonosAsesoria.class, datos.get(0));
    }
}
