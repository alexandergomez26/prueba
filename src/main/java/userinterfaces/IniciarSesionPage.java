...
public class IniciarSesionPage extends PageObject {
    ...
    public static final Target BTN_SIGUIENTE = Target.the("Botón para continuar a ingresar la clave")
    ...
    public static final Target BTN_NO_MANTENER_SESION_INICIADA = Target.the("Botón para no mantener la sesión iniciada")
