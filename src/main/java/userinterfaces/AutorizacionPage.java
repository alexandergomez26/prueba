...
public class AutorizacionPage extends PageObject {
    ...
    public static final Target TXT_TRANSACCIONES = Target.the("Menú transacciones")
            .located(By.id("menu__section-1"));

    public static final Target TXT_CLIENTE_ACTUAL = Target.the("texto cliente actual")
            .located(By.id("md-list-0__item-0"));

    public static final Target TXT_CLIENTE_POTENCIAL = Target.the("texto cliente potencial")
    ...
    public static final Target BONO_A_PARTIR_EDAD_DEFINIDA = Target.the("bono")
    ...
    public static final Target MESADA_CON_BENEFICIARIO = Target.the("mesada")
    ...
    public static final Target TARJETA_BENEFICIARIO = Target.the("tarjeta expandible beneficiario")
    ...
    public static final Target PARENTESCO_BENEFICIARIO = Target.the("parentesco beneficiario")
            .located(By.xpath("(//span[@class='h6-medium-fc-primary'])[2]"));

    public static final Target FECHA_NACIMIENTO_BENEFICIARIO = Target.the("fecha de nacimiento beneficiario")
            .located(By.xpath("(//span[@class='h6-medium-fc-primary'])[3]"));

    public static final Target GENERO_BENEFICIARIO = Target.the("genero del beneficiario")
            .located(By.xpath("(//span[@class='h6-medium-fc-primary'])[4]"));

    public static final Target SEMANAS_TOTALES_COTIZADAS = Target.the("semanas totales cotizadas")
            .located(By.xpath("(//label[@class='body-regular-fc-medium body-regular-fc-primary d-block'])[8]"));

    public static final Target SALDO_CAI= Target.the("saldo cai")
    ...
    public static final Target SBC = Target.the("salario basico de cotizacion")
    ...
    public static final Target FECHA_PRIMERA_SOLICITUD = Target.the("fecha de primera solicitud")
    ...
    public static final Target VALOR_MESADA_A_PARTIR_EDAD_DEFINIDA_12 = Target.the("valor mesada")
            .located(By.xpath("(//*[@id=\"ResultTableInterFromAgeDefined\"]/tbody/tr[1]/td[5]/span)[4]"));

    public static final Target VALOR_PENSION_A_PARTIR_EDAD_DEFINIDA_0 = Target.the("valor pension")
    ...
    public static final Target FECHA_CUENTA_INDIVIDUAL = Target.the("fecha de cuenta individual")
            .located(By.id("individualAccountDate"));

    public static final Target VALOR_APORTES_RPM_NO_BONO = Target.the("valor de aportes RPM no bono")
