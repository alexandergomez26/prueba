...
public class IngresarAPartirEdadDefinidaPage extends PageObject {
    ...
    public static final Target RBTN_PENSION_VEJEZ= Target.the("RadioButton para seleccionar la opción pensión vejez")
            .locatedBy("//label[@id='radioButtonProduct']/span/p");

    public static final Target BTN_CALCULAR= Target.the("Botón que dirige a ingresar la edad de pensión")
            .located(By.id("BtnTypePensionCard"));

    public static final Target TXT_A_PARTIR_EDAD_DEFINIDA= Target.the("Caja de texto para ingresar la edad definida")
            .located(By.id("input-radio-from-defined-age"));

    public static final Target BTN_REALIZAR_SIMULACION= Target.the("Botón para realizar la simulación")
            .located(By.id("BtnEnterAgeSubmit"));

    public static final Target CHECK_SELECCIONADO= Target.the("Check seleccionado")
            .locatedBy("(//label[@id='radioButtonProduct'])[1]//span[@class='control--icon']");

    public static final Target CHECK_APARTIR_EDAD_DEFINIDA= Target.the("seleccionar a partir de una edad definida")
    ...
    public static final Target TXT_DATOS_HISTORIA_LABORAL= Target.the("seleccionar datos de historia laboral")
            .located(By.id("card-title__icon-div-chevron-WorkingHistoryCard--card"));

    public static final Target TXT_A_FECHA_DE_TRASLADO= Target.the("Caja de texto para ingresar la edad definida")
            .located(By.id("BasicDataCard--form-container-item-summaryWeeks-transferWeekNumber"));

    public static final Target INGRESO_A_LA_VIDA_LABORAL= Target.the("Seleccionar ingreso a la vida laboral")
            .located(By.id("BasicDataCard--form-container-item-entryWorkingLife"));

    public static final Target DESPUES_DE_JUNIO= Target.the("Seleccionar despues de junio 30/92")
    ...
    public static final Target OPCT_APORTES_OBLIGATORIOS= Target.the("caja de texto para el valor de los aportes obligatorios")
            .located(By.id("BasicDataCard--form-container-item-contributions-required"));

    public static final Target BTN_CONTINUAR_DATOS_BASICOS= Target.the("Botón continuar con los datos basicos")
            .located(By.id("BtnaBasicDataForm"));

       public static final Target TXT_SALARIO_A_JUNIO_30= Target.the("Caja de texto para ingresar el salario a junio 30/92")
            .located(By.id("inforBasicCard--item-salaryJune3092"));

    public static final Target BTN_CALCULAR_VALOR_BASICO_BONO= Target.the("Botón para calcular el valor basico del Bono.")
            .located(By.id("BtnCalculateBond"));

    public static final Target BTN_CONTINUAR_REGISTRO_INFORMACION= Target.the("Botón para continuar con el registro de la información")
    ...
    public static final Target TXT_MES_INICIAL= Target.the("caja de texto del mes inicial")
            .locatedBy("(//select[@id='selectMonth'])[2]");

    public static final Target OPCT_MES_INICIAL= Target.the("caja de texto del mes inicial")
    ...
    public static final Target TXT_SALARIO= Target.the("caja de texto del salario")
            .located(By.id("RPMNoBono--form-container-item-contributionPeriods-quotationSalary"));

    public static final Target BTN_CONTINUAR_REGISTRO_BONO_MODALIDA_UNO= Target.the("Botón para continuar con el registro de la información del bono modalidad uno")
            .located(By.id("BtnBondModeOneFormSubmit"));

    public static final Target TXT_A_RPM_NO_BONO= Target.the("caja de texto de RPM no bono")
            .located(By.id("BasicDataCard--form-container-item-summaryWeeks-rpmNoBonusWeekNumber"));

    public static final Target TXT_FECHA_INICIAL_RPM= Target.the("campo fecha inicial")
    ...
    public static final Target TXT_SALARIO_RPM= Target.the("caja de texto del salario")
            .located(By.id("RPMNoBono--form-container-item-contributionPeriods-quotationSalary"));

    public static final Target BTN_CONTINUAR_APORTES_NO_BONO= Target.the("Botón para continuar con los aportes a semanas de RPM no bono")
            .located(By.id("BtnRPMNoBonoFormSubmit"));

    public static final Target TXT_PARENTESCO_BENEFICIARIO= Target.the("caja de texto para seleccionar el parentesco")
            .located(By.id("BasicDataCard--form-container-item-Parentesco Beneficiario 1"));

    public static final Target OPCT_PARENTESCO_BENEFICIARIO= Target.the("caja de texto para seleccionar el parentesco")
            .located(By.id("HIJO"));

    public static final Target OPCT_GENERO_BENEFICIARIO= Target.the("caja de texto para seleccionar el genero del beneficiario")
            .locatedBy("(//option[@id='M'])");

    public static final Target TXT_FECHA_NACIMIENTO_BENEFICIARIO= Target.the("campo fecha de nacimiento del beneficiario")
            .located(By.xpath("(//*[@id=\"datePicker\"])[2]"));

    public static final Target TXT_ANO_NACIMIENTO_BENEFICIARIO= Target.the("caja de texto del año de nacimiento del beneficiario")
            .locatedBy("(//select[@id='selectYear'])[2]");

    public static final Target OPCT_ANO_NACIMIENTO_BENEFICIARIO= Target.the("caja de texto del año final")
            .locatedBy("(//select[@id='selectYear'])[2]//option[@value='1990']");

    public static final Target OPCT_MES_NACIMIENTO_BENEFICIARIO= Target.the("caja de texto del año final")
            .locatedBy("(//select[@id='selectMonth'])[2]//option[contains(text(),'Mayo')]");

    public static final Target OPCT_DIA_NACIMIENTO_BENEFICIARIO= Target.the("caja de texto del dia de nacimiento del beneficiario")
