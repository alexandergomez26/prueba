...
public class VisualizaLosCampos implements Question<Boolean> {
    ...
    public VisualizaLosCampos(String texto1, String texto2, String texto3, String texto4, String texto5) {
        this.texto1 = texto1;
        this.texto2 = texto2;
        this.texto3 = texto3;
        this.texto4 = texto4;
    ...
    public Boolean answeredBy(Actor actor) {
        return TXT_TIPO_DOCUMENTO.resolveFor(actor).isPresent()
                ...
                && TXT_TIPO_DOCUMENTO.resolveFor(actor).isPresent()
                && TXT_TIPO_DOCUMENTO.resolveFor(actor).getText().equals(texto2)
    ...
    public static VisualizaLosCampos infoDatosBasicos(String texto1, String texto2, String texto3, String texto4, String texto5){
        return new VisualizaLosCampos( texto1,  texto2,  texto3,  texto4,  texto5); }
}
